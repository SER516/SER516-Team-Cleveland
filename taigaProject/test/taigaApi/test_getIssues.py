...
def issues():
    ...
    },
    {
        ...
        "owner_extra_info": {
            ...
            "photo": "https://media-protected.taiga.io/user/0/9/7/d/c589eb31c0d982a06f0ae045e9573c5eb95d773578a9d54892705ae83119/diamonds.png.80x80_q85_crop.png?token=Zd40Hw%3AB_aAhnvNzZU33-XRYfLpclJ321TvHkPAvUiye3oK3qLbS5dL8mWQcG5AZwRLQcuu5sGvcYDeBtOGp3vYJ-Zt8w",
            "big_photo": "https://media-protected.taiga.io/user/0/9/7/d/c589eb31c0d982a06f0ae045e9573c5eb95d773578a9d54892705ae83119/diamonds.png.300x300_q85_crop.png?token=Zd40Hw%3AyBKLK0_xcz18Es_ZIvRkX0oET8dlgIUQ8Wz3w5xVERi9_vvJVCECWxx8SUOBXUCD4bu1_CT-1pJP6Dw7Jkwieg",
        ...
        "subject": "Show Task Id and User Story Id on hover for Lead Time and Cycle Time",
        "external_reference": null,
        "version": 5,
        "watchers": [],
        "is_blocked": false,
...
def test_get_task_history(mock_get, issues, auth_token):
    ...
    result = get_issues("1521716", date.fromisoformat("2024-02-22"), date.fromisoformat("2024-02-26"), auth_token)
    expected_result = {
        'issues': [
            {
                'id': 1724585,
